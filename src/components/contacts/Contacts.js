...
const Contacts = ({ modal, hideContactsPage, instaIcon, gitIcon, gmailIcon }) => {
    return (
        <div className={modal ? '' : styles.hidden}>
            ...
            <div className={styles.backdrop}>
                <p className={styles['contact-text']}>
                    ...
                    beautiful, animated and respovsive one-page and multi-page sites without a server part. Working with databases and creating a
                    server is my goal in the near future, as well as deepening into already mastered technologies. To contact me about the development
                    of the website or if you have job offers for me, please follow the links below.
                </p>
